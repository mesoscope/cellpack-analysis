...
--config_path "/allen/aics/animated-cell/Saurabh/cellpack-analysis/data/configs/endosome_packing_config_variable.json" \
--generated_recipe_path "/allen/aics/animated-cell/Saurabh/cellpack-analysis/data/generated_recipes/20231031_endosome_variable" \
